...
from .graph_utils import graph_avg_pool, graph_upsample

__all__ = [
    'GCN_vert_convert', 'graph_upsample', 'graph_avg_pool', 'weights_init',
    'conv1x1'
]
...
def conv1x1(in_channels,
    ...
    layers = [
        nn.Conv2d(
            ...
            padding=0,
            bias=False),
        build_activate_layer(actFun), bn
    ]
...
def deconv3x3(in_channels,
    ...
    return nn.Sequential(
        ...
        nn.Conv2d(
            ...
            stride=1,
            padding=1,
            bias=False), build_activate_layer(actFun), bn)
